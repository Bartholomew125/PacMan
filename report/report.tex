...
For at vi alle har kunne arbejde sammen på projektet, benyttede vi os af \textbf{Git}. Brugen af Git har sikret os at vi kunne arbejde på det samme repository med forskellige "grene" til hver af os.
