...
\code{setState()} metoden i \class{Game} kan vi ændre på stadiet af spillet ved
...
\class{StateController}. Denne klasse har også en metode \code{setState()}, og
kalder \code{setState()}. Men hvis det så er en stadie, som \class{PowerState},
